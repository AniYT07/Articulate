  ...
  return (
    ...
    <div style={myStyle}>
      ...
      <div className="card-body">
        ...
        <p className="card-text" style={{fontFamily: "'Alkatra', 'cursive'", fontSize: '20px'}}>Articulate is a blog website which defines major world problems and provide with ideas to alleviate them in the most simple and easy to comprehend language. The goal of articulate is to provide people with proper insight about the major problems world is facing and spread awareness. More content will be available very soon along with forums and news page. Sign in feature has been added for the forums page. People can discuss and share their thoughts on the problems there.</p>
